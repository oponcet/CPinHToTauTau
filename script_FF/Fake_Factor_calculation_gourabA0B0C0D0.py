...
if __name__ == "__main__":
    ...
    # A = tautau__ss__iso1__iso2__nobjet ID: 109
    # B = tautau__ss__noniso1__iso2__nobjet  ID: 113
    # C = tautau__os__noniso1__iso2__nobjet  ID: 105
    # D = tautau__os__iso1__iso2__nobjet  ID: 101
    ...
    fakefator_values, fakefator_variance, fakefator_hist = calculate_ratio_hist(hists_mc_data_sub_DR[4303], hists_mc_data_sub_DR[4304])
