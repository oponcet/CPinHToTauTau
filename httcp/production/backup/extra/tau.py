    ...
    for the_shift in shifts:
        ...
        if do_syst:
            ...
            for region, region_mask in [
                ...
                e_single_region_mask = single_e_triggered & region_mask
                e_cross_region_mask = cross_e_triggered & ~single_e_triggered & region_mask
        ...
        if do_syst:
            ...
            for region, region_mask in [
                ...
                mu_single_region_mask = single_mu_triggered & region_mask
                mu_cross_region_mask = cross_mu_triggered & ~single_mu_triggered & region_mask
