...
input_files = glob.glob("httcp/fakes/FakeFactors/json/*.json")  # Replace with the path to your files
merged_structure = {
    "schema_version": 2,
...
output_file = f"httcp/fakes/FakeFactors/json/fake_factor_{year}.json"
