...
def main_FF(
    ...
    **kwargs,
    ...
    # tau selection +  anti Iso tau selection
    # e.g. tau_idx: [ [1], [0,1], [1,2], [], [0,1] ] 
    events, tau_results, good_tau_indices, good_antiIsotau_indices  = self[tau_selection](events,
                                                                                          call_force=True,
                                                                                          **kwargs)
    results += tau_results
    ...
    # e.g. [ [], [tau1, tau2], [], [], [] ]
    # FFDR_tautau_results, FFDR_tautau_indices_pair = self[FFDR_tautau_selection](events,
    #                                                              good_tau_indices,
    #                                                              call_force=True,
    #                                                              **kwargs)
    # results += FFDR_tautau_results


    # FFDR_tautau_pair = ak.concatenate([events.Tau[FFDR_tautau_indices_pair[:,0:1]], 
    #                               events.Tau[FFDR_tautau_indices_pair[:,1:2]]], 
    #                              axis=1)
    ...
    # rel-charge
    # events = self[rel_charge](events, **kwargs) # charge of the pair
