...
@selector(
    ...
    produces={
        ...
        #"trigger_types",
        "trigger_ids",
        "leg_minpt", "leg1_minpt", "leg2_minpt",
        "leg_matched_trigobj_idxs", "leg1_matched_trigobj_idxs", "leg2_matched_trigobj_idxs",
        "leg_matched_trigobjs", "leg2_matched_trigobjs", "leg2_matched_trigobjs",
    },
    exposed=True,
)
